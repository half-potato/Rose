...
void ConfigureFeatures(Device& device, vk::PhysicalDeviceFeatures& features, auto& createInfo) {
	...
	configureExtension.template operator()<vk::PhysicalDeviceFragmentShaderInterlockFeaturesEXT>(VK_EXT_FRAGMENT_SHADER_INTERLOCK_EXTENSION_NAME, [](vk::PhysicalDeviceFragmentShaderInterlockFeaturesEXT& v) {

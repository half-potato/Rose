...
struct GlobalParams_0
{
    ...
    float offset2_0;
    uint32_t dataSize_0;
    RWStructuredBuffer<float> data_0;
};
...
#line 16
    ...
    *(&((&kernelContext_0)->globalParams_0->data_0[_S3])) = (*(&((&kernelContext_0)->globalParams_0->data_0[_S3])) * (&kernelContext_0)->globalParams_0->PushConstants_0->scale_0 + (&kernelContext_0)->globalParams_0->PushConstants_0->offset_0) * (&kernelContext_0)->globalParams_0->scale2_0 + (&kernelContext_0)->globalParams_0->offset2_0;
    if(_S3 == 0U)
    {

#line 21
        Tuple_0 _S4 = { (&kernelContext_0)->globalParams_0->PushConstants_0->scale_0 };
        printf("scale = %0.2f\n", (&kernelContext_0)->globalParams_0->PushConstants_0->scale_0);

#line 22
        Tuple_0 _S5 = { (&kernelContext_0)->globalParams_0->PushConstants_0->offset_0 };
        printf("offset = %0.2f\n", (&kernelContext_0)->globalParams_0->PushConstants_0->offset_0);

#line 23
        Tuple_0 _S6 = { (&kernelContext_0)->globalParams_0->scale2_0 };

        printf("scale2 = %0.2f\n", (&kernelContext_0)->globalParams_0->scale2_0);

#line 25
        Tuple_0 _S7 = { (&kernelContext_0)->globalParams_0->offset2_0 };
...
void testMain_Thread(ComputeThreadVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    _testMain(varyingInput, entryPointParams, globalParams);
}
// [numthreads(32, 1, 1)]
SLANG_PRELUDE_EXPORT
void testMain_Group(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ...
    for (uint32_t x = 0; x < 32; ++x)
    {
        ...
        _testMain(&threadInput, entryPointParams, globalParams);
    }
}
// [numthreads(32, 1, 1)]
SLANG_PRELUDE_EXPORT
void testMain(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ...
    for (uint32_t z = vi.startGroupID.z; z < vi.endGroupID.z; ++z)
    {
        ...
        for (uint32_t y = vi.startGroupID.y; y < vi.endGroupID.y; ++y)
        {
            ...
            for (uint32_t x = vi.startGroupID.x; x < vi.endGroupID.x; ++x)
            {
                ...
                testMain_Group(&groupVaryingInput, entryPointParams, globalParams);
            }
        }
    }
}
